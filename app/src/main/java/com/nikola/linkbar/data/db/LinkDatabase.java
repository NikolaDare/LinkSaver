...
public abstract class LinkDatabase extends RoomDatabase {
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            noteDao.insert(new Links("Title 1", "Description 1",false,0));
            noteDao.insert(new Links("Title 2", "Description 2",false,0));
            noteDao.insert(new Links("Title 3", "Description 3",false,0));
